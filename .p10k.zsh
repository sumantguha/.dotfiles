# Generated by Powerlevel10k configuration wizard on 2021-05-14 at 10:33 IST.
...
# light-ornaments, sparse, many icons, fluent, instant_prompt=off.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%B${P9K_CONTENT} $(whoami | grep -v "^root\$")'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=black
